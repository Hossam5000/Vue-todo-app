...
var _stylesCss = require("./assests/styles.css");
const app = (0, _vue.createApp)((0, _appVueDefault.default));
app.mount("#app");

},{"vue":"gzxs9","./App.vue":"fYNyc","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./assests/styles.css":"4pWBM"}],"gzxs9":[function(require,module,exports) {
/**
* vue v3.5.13
...
let initialize = ()=>{
    ...
    script.__scopeId = "data-v-a0330b";
    script.__file = "/project/workspace/src/App.vue";
};
initialize();
if (module.hot) {
    script.__hmrId = "a0330b-hmr";
    module.hot.accept(()=>{
        setTimeout(()=>{
            initialize();
            if (!__VUE_HMR_RUNTIME__.createRecord("a0330b-hmr", script)) __VUE_HMR_RUNTIME__.reload("a0330b-hmr", script);
        }, 0);
    });
}
...
parcelHelpers.defineInteropFlag(exports);
var _vue = require("vue");
var _todoItemVue = require("./components/todoItem.vue");
var _todoItemVueDefault = parcelHelpers.interopDefault(_todoItemVue);
// cons & vars
exports.default = {
    __name: "App",
    setup (__props, { expose: __expose }) {
        __expose();
        // imports
        const inputNewTodo = (0, _vue.ref)("");
        // functions
        const __returned__ = {
            inputNewTodo,
            ref: (0, _vue.ref),
            todoItem: (0, _todoItemVueDefault.default)
        };
...
},{"vue":"gzxs9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./components/todoItem.vue":"iG2ws"}],"iG2ws":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
let script;
let initialize = ()=>{
    script = {};
    script.render = require("a74cac1c7884a623").render;
    script.__cssModules = require("68a1e6005266bc4d").default;
    require("ce77ce5952bdd809").default(script);
    script.__scopeId = "data-v-8b0567";
    script.__file = "/project/workspace/src/components/todoItem.vue";
};
initialize();
if (module.hot) {
    script.__hmrId = "8b0567-hmr";
    module.hot.accept(()=>{
        setTimeout(()=>{
            initialize();
            if (!__VUE_HMR_RUNTIME__.createRecord("8b0567-hmr", script)) __VUE_HMR_RUNTIME__.reload("8b0567-hmr", script);
        }, 0);
    });
}
exports.default = script;

},{"a74cac1c7884a623":"65HYD","ce77ce5952bdd809":"aWwdb","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","68a1e6005266bc4d":"dWsV5"}],"65HYD":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "render", ()=>render);
var _vue = require("vue");
...
function render(_ctx, _cache) {
    return (0, _vue.openBlock)(), (0, _vue.createElementBlock)("li", _hoisted_1, [
        _cache[0] || (_cache[0] = (0, _vue.createElementVNode)("div", {
            class: "left"
        }, [
            (0, _vue.createElementVNode)("i", {
                class: "fa-regular fa-circle"
            }),
            (0, _vue.createElementVNode)("span", null, "test task")
        ], -1 /* HOISTED */ )),
        (0, _vue.createCommentVNode)("./left"),
        ...
        (0, _vue.createCommentVNode)("./right")
    ]);
}
if (module.hot) module.hot.accept(()=>{
    __VUE_HMR_RUNTIME__.rerender("8b0567-hmr", render);
});

},{"vue":"gzxs9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"aWwdb":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
let NOOP = ()=>{};
exports.default = (script)=>{};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dWsV5":[function() {},{}],"evi43":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "render", ()=>render);
var _vue = require("vue");
    ...
    return (0, _vue.openBlock)(), (0, _vue.createElementBlock)((0, _vue.Fragment), null, [
        (0, _vue.createElementVNode)("div", _hoisted_1, [
            (0, _vue.withDirectives)((0, _vue.createElementVNode)("input", {
                "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event)=>$setup.inputNewTodo = $event),
            ...
            _cache[1] || (_cache[1] = (0, _vue.createElementVNode)("button", null, "ADD", -1 /* HOISTED */ ))
        ]),
        (0, _vue.createCommentVNode)("./container"),
        (0, _vue.createCommentVNode)(" todo list "),
        (0, _vue.createElementVNode)("ul", _hoisted_2, [
            (0, _vue.createVNode)($setup["todoItem"])
        ])
    ], 64 /* STABLE_FRAGMENT */ );
}
if (module.hot) module.hot.accept(()=>{
    __VUE_HMR_RUNTIME__.rerender("a0330b-hmr", render);
});
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1aWWh":[function() {},{}],"4pWBM":[function() {},{}]},["23E3a","aR1JP"], "aR1JP", "parcelRequirebaba")
